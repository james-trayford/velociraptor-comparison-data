...
input_filename_array = ["../raw/Smith2012_active.txt", "../raw/Smith2012_passive.txt"]
output_filename_array = ["Smith2012_active.hdf5", "Smith2012_passive.hdf5"]
...
for i in range(0, len(input_filename_array)):
    ...
    SNuM = unyt.unyt_array(
        10 ** raw.T[1] / 10 ** raw.T[0], units="yr**(-1) * Msun**(-1)"
    )
