...
input_filename = f"../raw/Abdurrouf2022.txt"
...
minimum_surface_density = 1.0 + 6.  # in their paper this seems to be the limit they can observe, however they do not say anything about this
