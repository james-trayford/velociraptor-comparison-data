...
Mstar_10kpc_scatter_low = (
    10 ** Mstar_10kpc_log - 10 ** (Mstar_10kpc_log - Mstar_10kpc_scatter_log)
) * unyt.Solar_Mass
Mstar_10kpc_scatter_high = (
    10 ** (Mstar_10kpc_log + Mstar_10kpc_scatter_log) - 10 ** Mstar_10kpc_log
) * unyt.Solar_Mass
Mstar_10kpc_scatter = unyt.unyt_array(
    (Mstar_10kpc_scatter_low, Mstar_10kpc_scatter_high), units=unyt.Solar_Mass
)
