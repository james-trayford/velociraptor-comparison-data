...
Phi = 2.51 * 10**raw[:, 3] * unyt.dimensionless
Phi_low = 2.51 * 10**(raw[:, 3] - raw[:, 5]) * unyt.dimensionless
Phi_high = 2.51 * 10**(raw[:, 3] + raw[:, 4]) * unyt.dimensionless

# Define the scatter as offset from the mean value
x_scatter = unyt.unyt_array((L1_4 - L1_4_low, L1_4_high - L1_4))
y_scatter = unyt.unyt_array((Phi - Phi_low, Phi_high - Phi_low))

comment = (" AGN radio luminosity data, taken from Sadler et al. (2002):"
           " 2002MNRAS.329..227S"
)
