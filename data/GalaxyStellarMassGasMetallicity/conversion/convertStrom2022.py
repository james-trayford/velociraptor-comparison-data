...
# Meta-data
comment = "The median stellar mass is 1e10 Msun."
citation = "Strom et al. (2022)"
bibcode = "2022ApJ...925..116S"
plot_as = "line"
redshift = np.array([2.0, 2.7])

M_star = unyt.unyt_array(np.logspace(9.0, 11.3, 100), units="Msun")

models = {
    "OH": {"alpha": (8.35, 0.02), "beta": (0.14, 0.05), "label": "12+log10(O/H)"},
    "NH": {"alpha": (7.07, 0.03), "beta": (0.29, 0.07), "label": "12+log10(N/H)"},
    "FeH": {"alpha": (-0.69, 0.02), "beta": (0.17, 0.22), "label": "[Fe/H]"},
}
