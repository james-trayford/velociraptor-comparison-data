...
y_scatter = unyt.unyt_array((-10**(2*np.log10(Phi)-np.log10(Phi_high))+Phi, Phi_high - Phi))

comment = (" The black hole mass function estimate taken from Caramete et al. (2010):"
           " 2010A&A...521A..55C"
