...
input_filename = "../raw/Horesh2008.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on the SDSS-I overlap area."
citation = "Horesh et al. (2008)"
bibcode = "2008MNRAS.389.1871H"
