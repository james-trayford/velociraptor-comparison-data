...
input_filename = "../raw/Dahlen2012.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on the Extended Hubble Space Telescope Supernova Survey."
citation = "Dahlen et al. (2012)"
bibcode = "2012ApJ...757...70D"
