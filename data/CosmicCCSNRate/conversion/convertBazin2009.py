...
input_filename = "../raw/Bazin2009.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on the Supernova Legacy Survey (SNLS)."
citation = "Bazin et al. (2009)"
bibcode = "2009A&A...499..653B"
