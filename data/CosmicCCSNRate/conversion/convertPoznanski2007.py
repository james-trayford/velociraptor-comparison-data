...
input_filename = "../raw/Poznanski2007.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on deep SN survey on the Subaru Deep Field (SDF)."
citation = "Poznanski et al. (2007)"
bibcode = "2007MNRAS.382.1169P"
...
output_path = f"../Poznanski2007.hdf5"
