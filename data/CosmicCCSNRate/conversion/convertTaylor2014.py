...
input_filename = "../raw/Taylor2014.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on the Sloan Digital Sky Survey II Supernova Survey (SDSS-II SNS)."
citation = "Taylor et al. (2014)"
bibcode = "2014ApJ...792..135T"
