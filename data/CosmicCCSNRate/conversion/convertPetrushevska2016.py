...
input_filename = "../raw/Petrushevska2016.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on observations with the HAWK-I instrument on VLT, with supporting optical data from the Nordic Optical Telescope."
citation = "Petrushevska et al. (2016)"
bibcode = "2016A&A...594A..54P"
...
output_path = f"../Petrushevska2016.hdf5"
