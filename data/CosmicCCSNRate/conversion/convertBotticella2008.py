...
input_filename = "../raw/Botticella2008.dat"

processed = ObservationalData()
raw = np.loadtxt(input_filename)

comment = "Based on the Southern inTermediate Redshift ESO Supernova Search (STRESS)."
citation = "Botticella et al. (2008)"
bibcode = "2008A&A...479...49B"
...
output_path = f"../Botticella2008.hdf5"
